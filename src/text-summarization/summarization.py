...
# Uncomment both of these lines ONLY when you're running this script for the first time. 
# download('stopwords')
# download('punkt')

# Opening File for writing

text_file = open("summarized-text.txt", "w")

# Reading Data

text = open("sample-data.txt","r").read() # import text file extracted from audio
